...
## Corpus Check
- 274 files · ~224,749 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1536 nodes · 3267 edges · 128 communities (91 shown, 37 thin omitted)
...
Cohesion: 0.08
Nodes (41): ProviderCapability, assembleStaticPrompt(), DEFAULT_PROMPT_FILE(), loadPromptTemplate(), resolveDataspace(), resolveWorkspace(), resolveWorkspaces(), SessionContextInput (+33 more)
...
Cohesion: 0.12
Nodes (30): CharacterAssetRef, characterAssetUrl(), CharacterMotion, CharacterMotionBinding, CharacterVisual, CharacterVisualResponse, exportCharacterPackage(), fetchCharacterVisual() (+22 more)

### Community 14 - "inner.ts"
Cohesion: 0.09
Nodes (47): server, createDurableSocket(), PHASE_BY_EVENT, publishRunEvent(), RAW_SOCKET, RunEventRow, runEventStore, terminalStatus() (+39 more)

### Community 15 - "apiGet"
Cohesion: 0.16
Nodes (19): deleteCharacter(), apiDelete(), apiGet(), createProvider(), deleteProvider(), fetchBuiltinProviders(), fetchCustomProviders(), fetchProviderModels() (+11 more)
...
Cohesion: 0.14
Nodes (20): AttachmentRecord, ContentPart, isImage(), isTextExtension(), isTextLike(), lowerContentToProvider(), mediaPart, ProviderContentBlock (+12 more)
...
Cohesion: 0.13
Nodes (22): CronFields, dayOfWeek(), daysInMonth(), LocalParts, NextFireOptions, nextFireTime(), normalizeClock(), parseCronExpression() (+14 more)

### Community 24 - "EventsPage.tsx"
Cohesion: 0.17
Nodes (22): apiPost(), archiveEventDefinition(), createEventDefinition(), CreateEventDefinitionInput, deleteEventDefinition(), EventDefinition, EventOccurrence, fetchEventOccurrences() (+14 more)

### Community 25 - "apiGet"
Cohesion: 0.08
Nodes (43): ComposeContext, InnerResult, ToolCallRecord, detectDoomLoop(), evaluateFinalAnswer(), evaluateSubmission(), FinalAnswerDecision, hasRepeatingPattern() (+35 more)
...
Cohesion: 0.13
Nodes (20): CharacterSnapshotContent, CharacterRevisionSnapshot, CHAR_DIR(), CharacterMemory, CharacterRecord, ensureCharDir(), normalizeRecord(), pathFor() (+12 more)
...
Cohesion: 0.12
Nodes (19): DEV_CORS_ORIGINS, isLoopbackOrigin(), MIME, serveClientHandler(), StartServerOptions, startTianshuServer(), TianshuServer, stopAssetGC() (+11 more)

### Community 40 - "InputToolbar.vue"
Cohesion: 0.15
Nodes (22): checkStrategy(), checkToolBinding(), deepCloneToolCall(), estimateTokenCount(), innerLoop(), matchToolCall(), READ_ONLY_TOOLS, retries (+14 more)
...
Cohesion: 0.10
Nodes (37): SessionSkillActivation, sessionSkillStore, ensureInside(), fileType(), findSkillPackage(), listFiles(), listSkillPackages(), parseSkillFrontmatter() (+29 more)
...
Cohesion: 0.14
Nodes (18): getDataDir(), DEBUG_DIR(), logLLMCall(), systemPromptFingerprint(), DEBUG_DIR(), deleteOldDebugSessions(), mergeOldDebugTurns(), defaults (+10 more)
...
Cohesion: 0.15
Nodes (17): mergeContent(), getDangerousTools(), matchPath(), parseFileSize(), resolveCharacterTools(), validateByRule(), validateConstraints(), executeTool() (+9 more)
...
Cohesion: 0.21
Nodes (10): LLMChunk, LLMOptions, LLMUsage, parseUsage(), streamChatCompletion(), ToolCall, describeTransportError(), getErrorCode() (+2 more)

### Community 78 - "asset-gc.ts"
Cohesion: 0.39
Nodes (7): runAssetGC(), startAssetGC(), assetIdsFromVisual(), hasProtectingRef(), registerAssetRefs(), touchPlayerLease(), characterVisualStore
...
## Knowledge Gaps
- **422 isolated node(s):** `name`, `version`, `description`, `author`, `private` (+417 more)
...
- **Why does `getDataDir()` connect `MarkdownRenderer.vue` to `ChatInput.tsx`, `SkillSettings.vue`, `index.ts`, `attachments.ts`, `cronRegistry.ts`, `InputToolbar.vue`, `outer.ts`, `config.ts`, `providerStore.ts`, `offlineMiner.ts`, `skill-loader.ts`, `inner.ts`, `registry.ts`, `context-builder.ts`, `workspace.ts`, `App.tsx`, `run-store.ts`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `startTianshuServer()` connect `CharacterSelector.vue` to `dependencies`, `eventExecutor.ts`, `inner.ts`, `asset-gc.ts`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `getDb()` connect `inner.ts` to `checkpoint-store.ts`, `SkillSettings.vue`, `cronRegistry.ts`, `CharacterSelector.vue`, `config.ts`, `offlineMiner.ts`, `asset-gc.ts`, `skill-loader.ts`, `eventExecutor.ts`, `MarkdownRenderer.vue`, `apiGet`?**
